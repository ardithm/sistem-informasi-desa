<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a
                href="{{ route('admin.penduduks.create') }}"
    ...
    <div class="py-8">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 mb-6">
                ...
                <form
                    method="GET"
                    action="{{ route('admin.penduduks.index') }}"
                    class="flex gap-3">
                        ...
                        <tbody class="divide-y">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-right">
                                    ...
                                    <form
                                        action="{{ route('admin.penduduks.destroy', $penduduk) }}"
                                        method="POST"
                                        class="inline"
                                        onsubmit="return confirm('Yakin ingin menghapus data {{ $penduduk->nama_lengkap }}? Data yang sudah memiliki pengajuan tidak dapat dihapus.');">
                                        @csrf
                                        @method('DELETE')
